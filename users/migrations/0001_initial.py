    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_sum', models.DecimalField(blank=True, decimal_places=2, default=0, max_digits=10, null=True, verbose_name='сумма оплаты')),
                ('is_card', models.BooleanField(default=True, verbose_name='оплата переводом')),
                ('session_id', models.CharField(blank=True, null=True, verbose_name='Id сессии')),
                ('link', models.URLField(blank=True, null=True, verbose_name='Cсылка на оплату')),
